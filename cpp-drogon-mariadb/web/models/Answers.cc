...
const std::string Answers::primaryKeyName = "id";
const bool Answers::hasPrimaryKey = true;
...
{"question_id","int32_t","int(11)",4,0,0,0},
...
const typename Answers::PrimaryKeyType & Answers::getPrimaryKey() const
{
    assert(id_);
    return *id_;
}
